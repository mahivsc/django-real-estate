# Generated by Django 3.2.7 on 2022-05-01 15:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(default='+917207380451', max_length=30, region=None, verbose_name='Phone Number')),
                ('about_me', models.TextField(default='say somthing about yourself', verbose_name='About me')),
                ...
                ('country', django_countries.fields.CountryField(blank='False', default='IN', max_length=2, verbose_name='Country')),
                ('city', models.CharField(default='Dheli', max_length=180, verbose_name='City')),
                ('is_buyer', models.BooleanField(default=False, help_text='Are you looking to sell a property?', verbose_name='Buyer')),
