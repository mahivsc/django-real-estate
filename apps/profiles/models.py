...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"), max_length=30, default="+917207380451")
    about_me = models.TextField(verbose_name=_("About me"), default="say somthing about yourself")
    ...
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Dheli", blank=False, null=False)
    is_buyer = models.BooleanField(verbose_name=_("Buyer"), default=False, help_text=_("Are you looking to sell a property?"))
